        ...
        <div id="corps">
            ...
            <div id="corpstxt">
               <h2>Connexion</h2>
                ...
                <center><table>
                    <tr align="CENTER"><td><h3>Par compte :</h3></td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr align="CENTER"><td><asp:TextBox ID="username" placeholder="Nom d'utilisateur..." runat="server" Width="100"></asp:TextBox></td></tr>
                    <tr align="CENTER"><td><asp:TextBox ID="password" TextMode="password" placeholder="Mot de passe..." runat="server" Width="100"></asp:TextBox></td></tr>
                    <tr align="CENTER"><td><asp:Button ID="connectwithinfos" Text="Se connecter !" runat="server" Width="110px" OnClick="connectwithinfos_Click" /></td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr><td><img src="CSS/Images/fhr.gif" /></td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr align="CENTER"><td valign="middle"><h3>Par licence :</h3></td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr align="CENTER"><td><asp:TextBox ID="licence1" placeholder="Partie 1..." runat="server" Width="100"></asp:TextBox>
                        <asp:TextBox ID="licence2" placeholder="Partie 2..." runat="server" Width="100"></asp:TextBox>
                        <asp:TextBox ID="licence3" placeholder="Partie 3..." runat="server" Width="100"></asp:TextBox></td></tr>
                    <tr align="CENTER"><td><asp:Button ID="connectwithkey" Text="Se connecter !" runat="server" Width="110px" OnClick="connectwithkey_Click" /></td></tr>
                </table></center>
